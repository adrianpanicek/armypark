<?php
class CL_Widget_Links extends WP_Widget {
	public function __construct() {
		$widget_ops = array('description' => __( "CitronLinky" ) );
		parent::__construct('cl-links', __('CitronLinky'), $widget_ops);
	}
	/**
	 * @param array $args
	...
	public function widget( $args, $instance ) {
		...
		$title = ( ! empty( $instance['title'] ) ) ? $instance['title'] : __( 'Linky' );
		$title = apply_filters( 'widget_title', $title, $instance, $this->id_base );



		$r = get_bookmarks(array(
			'orderby' => $orderby,
			'limit' => $limit,
			'category' => $category
		));
...
?>
		<div class="news-item">
			<h3>
				<a href="<?php echo $link->link_url; ?>" class="title"><?php echo $link->link_name; ?></a>
			</h3>
...
<?php
	...
	public function form( $instance ) {
		//Defaults
		$instance = wp_parse_args( (array) $instance, array( 'images' => true, 'name' => true, 'description' => false, 'rating' => false, 'category' => false, 'orderby' => 'name', 'limit' => -1, 'title' => 'Linky' ) );
